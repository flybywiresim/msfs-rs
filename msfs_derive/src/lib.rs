...
/// Declare a system callback, which is a 2024 exclusive feature.
/// This generates the new-style callbacks: `NAME_system_init`, `NAME_system_update`,
/// and `NAME_system_kill`.
/// ```rs
/// use futures::stream::{Stream, StreamExt};
/// // Declare and export the system `FOO`
/// #[msfs::system]
/// async fn FOO(mut gauge: msfs::Gauge) -> Result<(), Box<dyn std::error::Error>> {
///   while let Some(event) = gauge.next_event().await {
///     // ...
...
pub fn system(args: TokenStream, item: TokenStream) -> TokenStream {
    ...
    let output = quote! {
        ...
        #[doc(hidden)]
        #[unsafe(no_mangle)]
        extern "C" fn #extern_system_name_init(
            ctx: ::msfs::sys::FsContext,
        ...
        #[doc(hidden)]
        #[unsafe(no_mangle)]
        extern "C" fn #extern_system_name_update(
            ctx: ::msfs::sys::FsContext,
            d_time: std::os::raw::c_float,
        ) {
            unsafe {
               ::msfs::wrap_executor(&raw mut #executor_name, |e| e.handle_systems_update(ctx, d_time.into()));
            }
        }

        #[doc(hidden)]
        #[unsafe(no_mangle)]
        extern "C" fn #extern_system_name_kill(
            ctx: ::msfs::sys::FsContext,
        ) -> bool {
            unsafe {
                ::msfs::wrap_executor(&raw mut #executor_name, |e| e.handle_systems_kill(ctx))
            }
        }
    };
...
pub fn gauge2024(args: TokenStream, item: TokenStream) -> TokenStream {
    ...
    let output = quote! {
        ...
        #[doc(hidden)]
        #[unsafe(no_mangle)]
        extern "C" fn #extern_gauge_update(
            ctx: ::msfs::sys::FsContext,
            d_time: std::os::raw::c_float,
        ) -> bool {
            unsafe {
        ...
        #[doc(hidden)]
        #[unsafe(no_mangle)]
        extern "C" fn #extern_mouse_handler(
            ctx: ::msfs::sys::FsContext,
            fx: std::os::raw::c_float,
            fy: std::os::raw::c_float,
